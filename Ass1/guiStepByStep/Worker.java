...
public class Worker extends Thread {
	...
	/*
	 * name : thread name context: shared context start: index of the first ball
	 * assigned to the thread (included) lastIndex: index of the last ball
	 * assigned to the thread (not included)
	 */
